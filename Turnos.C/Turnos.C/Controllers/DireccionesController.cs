...
namespace Turnos.C.Controllers
{
    public class DireccionesController : Controller
    {
        ...
        public DireccionesController(TurnosContext context)
        {
            _context = context;
        }
        ...
        {
            var turnosContext = _context.Direcciones.Include(d => d.Persona);
        ...
        public async Task<IActionResult> Create([Bind("Id,Calle,Altura,Piso,Departamento,PersonaId")] Direccion direccion)
        {
